...
namespace DevIO.Api.Extensions
{
    public class JsonWithFilesFormDataModelBinder : IModelBinder
    {
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            // Now, bind each of the IFormFile properties from the other from parts
            foreach (var property in bindingContext.ModelMetadata.Properties)
            {
                ...
                {
                    // The IFormFile was successfully bound, assing it to the corresponding property of the model
            ...
            // Set the successfully constructed model was the result of the model binding
